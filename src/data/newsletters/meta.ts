...
export const newsletterMeta: NewsletterMeta[] = [
  ...
  {
    id: "weekly-2026-rw007",
    title:
      "Raycast Weekly RW007：SF / NYC Glaze 活動、Raycast v2 rollout 與 GPT Image 2",
    date: "2026-05-09",
    type: "weekly",
    theme: "emerald",
    kicker: "Raycast Weekly",
    summary:
      "第七期週報整理 SF 與 NYC 的 Raycast / Glaze 活動、Raycast v2 rollout、GPT Image 2、Glaze 社群作品與本週新上架擴充。",
    author: "Alexi | Raycast Weekly",
    episode: "RW007",
  },
];
